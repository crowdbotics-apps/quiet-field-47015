"""
Django settings for quiet_field_47015 project.
...
ROOT_URLCONF = 'quiet_field_47015.urls'
...
WSGI_APPLICATION = 'quiet_field_47015.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "quiet_field_47015 API",
    "DESCRIPTION": "API documentation for quiet_field_47015 App",
    "VERSION": "v1",
}
